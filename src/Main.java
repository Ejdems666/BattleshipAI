...
import r33.ai.mode.ParityCalculator;
...
//        ParityCalculator parityCalculator = new ParityCalculator(0);
//        Field field = new Field(10, 10);
//        HuntMode huntMode = new HuntMode(field,parityCalculator);
...
//        huntMode = new HuntMode(field,parityCalculator);
//        for (int i = 0; i < 20; i++) {
//            field.setLastShot(huntMode.getShot(fleet));
//            field.registerHit(false);
//        }
